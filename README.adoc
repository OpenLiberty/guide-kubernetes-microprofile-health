...
name-deployment-8664868cd7-f2jbc   1/1       Running   0          4m
...
name-deployment-8664868cd7-f2jbc   0/1       Running   0          7m
...
----
NAME                               READY     STATUS    RESTARTS   AGE
name-deployment-8664868cd7-bwdkl   0/1       Running   0          8m
name-deployment-8664868cd7-f2jbc   0/1       Running   0          8m
...
----
NAME                               READY     STATUS    RESTARTS   AGE
name-deployment-8664868cd7-bwdkl   1/1       Running   0          10m
name-deployment-8664868cd7-f2jbc   1/1       Running   0          10m
ping-deployment-55f45bffc4-7njlp   1/1       Running   0          10m
----
