...
[role='command']
```
mvnw.cmd failsafe:integration-test -Dsystem.service.root=localhost:31000 -Dinventory.service.root=localhost:32000
```
--
...
[role='command']
```
./mvnw failsafe:integration-test -Dsystem.service.root=localhost:31000 -Dinventory.service.root=localhost:32000
```
--
