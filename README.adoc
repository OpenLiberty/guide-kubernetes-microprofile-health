...
:page-seo-description: A tutorial with examples of how to report the health status of Java microservices using MicroProfile Health Check endpoints and inspect them with Kubernetes readiness and liveness probes.
