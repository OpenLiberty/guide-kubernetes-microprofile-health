...
----
 ...
 You will notice that one of the two `name` pods is no longer in the ready state. Navigate to `{name-api}`. Observe that your request is still successful because you have two replicas and one is still healthy.
