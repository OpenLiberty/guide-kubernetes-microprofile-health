...
:page-seo-title: Kubernetes readiness and liveness probe tutorial
:page-seo-description: How to setup liveness probes and readiness probes in Kubernetes
...
Learn how to keep microservices healthy on Kuberenetes by setting up readiness and liveness probes to check MicroProfile Health endpoints.
